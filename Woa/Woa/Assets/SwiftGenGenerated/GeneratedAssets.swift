...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let arts = ImageAsset(name: "arts")
    internal static let authDecor = ImageAsset(name: "authDecor")
    internal static let backCell = ImageAsset(name: "backCell")
    ...
    internal static let changeProfile = ImageAsset(name: "changeProfile")
    ...
    internal static let houseS = ImageAsset(name: "houseS")
    internal static let likeSelected = ImageAsset(name: "likeSelected")
    internal static let likeUnselected = ImageAsset(name: "likeUnselected")
    internal static let profileDecor1 = ImageAsset(name: "profileDecor1")
    internal static let profileDecor2 = ImageAsset(name: "profileDecor2")
    internal static let profileDecor3 = ImageAsset(name: "profileDecor3")
    internal static let profileDecor4 = ImageAsset(name: "profileDecor4")
    internal static let purchases = ImageAsset(name: "purchases")
    internal static let second = ImageAsset(name: "second")
    internal static let selectFour = ImageAsset(name: "selectFour")
    ...
    internal static let unarchive = ImageAsset(name: "unarchive")
  ...
  internal enum Colors {
    ...
    internal static let ligthPink = ColorAsset(name: "ligthPink")
    internal static let placeholder = ColorAsset(name: "placeholder")
    internal static let profileItems = ColorAsset(name: "profileItems")
    internal static let selectedIcons = ColorAsset(name: "selectedIcons")
    internal static let textFieldText = ColorAsset(name: "textFieldText")
    internal static let unchosenScreen = ColorAsset(name: "unchosenScreen")
  }
}
