...
final class UIFactoryMethod: UIFactoryMethodProtocol {
    ...
    func createButton(type: ButtonType, action: UIAction? = nil, title: String? = nil, isLike: Bool? = nil, isInCart: Bool? = nil, isSelling: Bool? = nil, isSelled: Bool? = nil) -> UIButton {
        buttonFactoryMethod.createButton(type: type, action: action, title: title, isLike: isLike, isInCart: isInCart, isSelling: isSelling, isSelled: isSelled)
    }
